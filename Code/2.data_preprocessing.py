...
#Dataset_I = pd.read_csv('Finaldata_with_Fourier.csv', parse_dates=['Date'])
...
#     yc = list()
#
#     for i in range(len(X_data) - n_steps_in):
#         X_value = X_data[i: i + n_steps_in][:, :]
#         y_value = y_data[i + n_steps_in + 1: i + n_steps_in + n_steps_out + 1, 0]
#         print(y_value)
#         print(y_value.shape)
...
# yc_test = yc_test.reshape(yc_test.shape[0], 1)
# yc_train = yc_train.reshape(yc_train.shape[0], 1)
# %% --------------------------------------- Save dataset -----------------------------------------------------------------
...
#print('train_predict_index: ', train_predict_index.shape)
#print('test_predict_index: ', test_predict_index.shape)
